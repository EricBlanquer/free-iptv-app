...
describe('Storage Cache Info Tracking', () => {
    ...
    beforeEach(() => {
        app = new IPTVApp();
        app.settings = { playlists: [], hideSD: false, hide3D: false, hideHearingImpaired: false, providerLanguage: undefined };
        mockStore = {
            get: jest.fn(),
            put: jest.fn(),
            delete: jest.fn(),
                    ...
                    request.onsuccess({
                        target: {
                            result: {
                                ...
                                data: cachedData,
                                filters: { hideSD: false, hide3D: false, hideSM: false, providerLanguage: undefined }
                            }
                        }
                    });
                }, 0);
