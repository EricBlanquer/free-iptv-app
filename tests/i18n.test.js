...
// Setup DOM
document.body.innerHTML = '<div data-i18n="disclaimer.title"></div>';
...
// Load the I18n module (i18n-data.js must be loaded first as i18n.js depends on I18nData)
const fs = require('fs');
const i18nDataCode = fs.readFileSync('./js/i18n-data.js', 'utf8');
eval(i18nDataCode);
...
describe('I18n', () => {
    ...
    describe('t (translate)', () => {
        ...
        it('should translate disclaimer.title in English', () => {
