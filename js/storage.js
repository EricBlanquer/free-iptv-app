...
IPTVApp.prototype.logMemory = function() {};
...
IPTVApp.prototype.updateWatchHistoryProgress = function(id, position, duration, forceSync) {
...
IPTVApp.prototype.updateRefreshProgress = function(playlistId, step, total, name) {
    ...
    existing.textContent = '⏳ ' + step + '/' + total + ' ' + name;
};
