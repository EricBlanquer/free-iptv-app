...
IPTVApp.prototype.loadVisibleImages = function(forceFromStart) {
        ...
        if (!imageUrl) {
            ...
            (function(div, url, idx) {
                ...
                var timeoutId = setTimeout(function() {
                    ...
                    window.log('HTTP', 'IMG [' + idx + '] TIMEOUT after 30s: ' + url);
                }, 30000);
                img.onload = function() {
                    ...
                    if (duration > 1000) {
                        window.log('HTTP', 'IMG [' + idx + '] SLOW ' + duration + 'ms: ' + url);
                    }
                };
                img.onerror = function() {
                    ...
                    div.classList.add('no-image');
                    window.log('HTTP', 'IMG [' + idx + '] ERROR ' + duration + 'ms: ' + url);
                };
                img.src = url;
            })(imageDiv, imageUrl, i);
        }
    ...
    if (toLoad > 0 || noUrl > 0) {
        window.log('HTTP', 'IMG load: ' + toLoad + ' to load, ' + noUrl + ' no URL, ' + alreadyLoaded + ' cached (range ' + startIdx + '-' + endIdx + ')');
    }
};
