...
IPTVApp.prototype.updateFavoriteButton = function() {
    ...
    if (favBtn && this.selectedStream) {
        ...
        var idToCheck = this.selectedStream.seriesId || (data && (data.series_id || data.stream_id)) || this.selectedStream.id;
...
IPTVApp.prototype.showFavoritesInGrid = function() {
    ...
    this.favorites.forEach(function(fav, idx) {
        if (activePlaylistId && fav._playlistId && String(fav._playlistId) !== String(activePlaylistId)) return;
